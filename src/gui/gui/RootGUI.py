...
class RootGUI(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.typeRBox = wx.RadioBox(self, wx.ID_ANY, _("Type"), choices=[_(".FDF"), _(".ANI"), _(".output"), _("pdos.xml")], majorDimension=4, style=wx.RA_SPECIFY_COLS)
        self.downBtn = wx.Button(self, wx.ID_ANY, _(">>"))
        self.upBtn = wx.Button(self, wx.ID_ANY, _("<<"))
        self.static_line_1 = wx.StaticLine(self, wx.ID_ANY)
        self.getDataBtn = wx.Button(self, wx.ID_ANY, _("Get calc data"))
        self.enqueueBtn = wx.Button(self, wx.ID_ANY, _("Enqueue job"))
        self.static_line_2 = wx.StaticLine(self, wx.ID_ANY)
        self.animateBtn = wx.Button(self, wx.ID_ANY, _("Animations"))
        ...
        self.optionsBtn = wx.Button(self, wx.ID_ANY, _("Options"))
        self.plotBtn = wx.Button(self, wx.ID_ANY, _("Plot"))
    ...
    def __set_properties(self):
        ...
        self.SetTitle(_("Siesta help scripts GUI"))
    ...
    def __do_layout(self):
        ...
        self.noteBook.AddPage(self.noteBook_panel_1, _("Properties"))
        self.noteBook.AddPage(self.noteBook_panel_2, _("Correlations"))
